...
namespace FocusSalesModule.Queries
{
    public class PaymentsTableQueries
    {
        ...
        public static string CreateAdvancePaymentTable()
        {
            return "IF OBJECT_ID(N'fsm_TemporaryAdvancePayments', N'U') IS NULL create table fsm_TemporaryAdvancePayments (  Id int IDENTITY PRIMARY KEY, DocumentTagId varchar(200),DocNo varchar(50), ReferenceNo varchar(300),Vtype int,CustomerId int)";
        }
