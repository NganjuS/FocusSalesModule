...
function getDocumentDetails(response) {
    ...
    updateDocStatus(companyId, sessionId, vtype, docNo);
}
async function updateDocStatus(companyId, sessionId, vtype, docNo) {

    var response = await fetch(`/focussalesmodule/api/salespayments/updatereceiptstatus/?compid=${companyId}&sessionid=${sessionId}&vtype=${vtype}&docno=${docNo}`);
